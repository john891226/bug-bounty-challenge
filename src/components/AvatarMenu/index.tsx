...
const AvatarMenu = forwardRef<HTMLDivElement, AvatarMenuProps>(
  ({ user }, ref) => {
    ...
    const avatarConfiguration = useMemo(() => stringAvatar(user), [user]);

    return (
      <div ref={ref}>
        <Avatar onClick={handleClick} {...avatarConfiguration} />
        <Menu
